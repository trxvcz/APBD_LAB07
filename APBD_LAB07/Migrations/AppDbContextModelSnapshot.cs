...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APBD_LAB07.Models.Component", b =>
                {
            ...
            modelBuilder.Entity("APBD_LAB07.Models.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_LAB07.Models.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_LAB07.Models.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_LAB07.Models.PcComponent", b =>
                {
                    b.Property<int>("PCId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_LAB07.Models.Component", b =>
                {
                    b.HasOne("APBD_LAB07.Models.ComponentManufacturer", "ComponentManufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBD_LAB07.Models.ComponentType", "ComponentType")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("APBD_LAB07.Models.PcComponent", b =>
                {
                    b.HasOne("APBD_LAB07.Models.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBD_LAB07.Models.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
